...
begin
  case RadioGroup1.ItemIndex of
    0: videoPath := ExtractFilePath(ParamStr(0)) + 'Video\Кардеры.wmv';
    1: videoPath := ExtractFilePath(ParamStr(0)) + 'Video\Жертвы обманщиков.wmv';
    2:Begin
        Form5.Hide;
        Form7.ShowModal;
      End;
    3: videoPath := ExtractFilePath(ParamStr(0)) + 'Video\Фишинг в реальности.wmv';
  end;
